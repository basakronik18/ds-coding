...
public class FindEulerianCircuit
{

    private int[][] adjacencyMatrix;
    private int numberOfNodes;

    public FindEulerianCircuit (int numberOfNodes, int[][] adjacencyMatrix)
    {
    ...
    public static void main (String... arg)
    {
        ...
        try
        {
            ...
            FindEulerianCircuit circuit = new FindEulerianCircuit(number_of_nodes, adjacency_matrix);
