...
public class FindFourElementsSumabequalsSumcd {
    ...
    public class pair {
        ...
        public boolean findPairs(int arr[]){
            ...
            //Traverse through all possible pair of arr[]
            for(int i=0; i<n; i++){
                for(int j=i+1; j<n; j++){
                    ...
                    //else sum is already present in the hash
                    else{
                        //find previous pair
                        pair p = map.get(sum);
    ...
    public static void main(String[] args) {
        FindFourElementsSumabequalsSumcd ffs = new FindFourElementsSumabequalsSumcd();
